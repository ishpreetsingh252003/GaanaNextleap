...
const SCRAPERS: Record<ReviewSource, () => Promise<ScrapeResult>> = {
...
export async function runScraping(
  ...
  console.log(`[Orchestrator] Starting scrape for sources: ${sources.join(", ")}`);
