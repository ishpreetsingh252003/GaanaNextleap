 ...
 * Triggers multi-source scraping and returns cleaned reviews.
 *
 * Body (all optional):
 * {
 *   sources?: string[]   // subset of sources to run; omit for all
 * }
 *
...
router.post("/scrape", async (req: Request, res: Response) => {
  ...
  try {
    ...
    const result = await runScraping(selectedSources);
