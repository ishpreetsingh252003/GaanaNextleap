...
export default function Home() {
  ...
  const badge = {
    ...
    ok: <span className="text-green-400">✓ Backend connected (Phase 2)</span>,
    error: <span className="text-red-400">✗ Backend offline – run npm run dev in phase2/backend</span>,
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-700 via-purple-500 to-blue-600 text-white">
      ...
      <main className="container mx-auto px-4 py-16 text-center">
        <div className="inline-block bg-white/20 text-white text-xs font-semibold px-3 py-1 rounded-full mb-4">
          Phase 2 – Multi-Source Review Scraper
        </div>

        <h1 className="text-5xl font-extrabold mb-4 tracking-tight">Gaana Discovery AI</h1>
        <p className="text-xl mb-10 max-w-2xl mx-auto text-white/90">
          Scrapes Gaana user feedback from <strong>6 sources</strong> — Google Play, App Store,
          Reddit, Quora, Web & Twitter — then pipes it into AI analysis.
        </p>
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { phase: "Phase 2", label: "Scraping", done: true, active: true },
            { phase: "Phase 3", label: "AI Analysis", done: false },
            { phase: "Phase 4", label: "Discovery", done: false },
          ].map((p) => (
