    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      <header className="bg-black/20 backdrop-blur-sm text-white px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-50" role="banner">
        ...
        <nav className="flex gap-3 sm:gap-5 text-xs sm:text-sm text-white/80" role="navigation" aria-label="Main navigation">
          ...
          <Link href="/about" className="text-white font-semibold border-b-2 border-red-500" aria-current="page">About</Link>
        </nav>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-red-400">🎯 Why This Was Built</h2>
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3 text-sm text-white/80 leading-relaxed backdrop-blur-sm">
            <p>
        ...
        {/* Validation approach */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-pink-400">📊 Review-Led Validation Approach</h2>
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-sm text-white/80 leading-relaxed space-y-3 backdrop-blur-sm">
            <p>
        ...
        {/* MVP Disclaimer */}
        <section className="mb-8">
          <div className="bg-amber-500/10 border-l-4 border-amber-500 rounded-r-xl p-6 backdrop-blur-sm">
            <h2 className="text-lg font-semibold text-amber-400 mb-2">⚠️ MVP Disclaimer</h2>
            ...
            {DATA_SOURCES.map((s) => (
              <div key={s.name} className="bg-white/5 border border-white/10 rounded-xl p-4 flex gap-4 hover:bg-white/10 transition-colors backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60 mt-0.5">{s.detail}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Privacy */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-white">🔒 Privacy &amp; Data Protection</h2>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <h3 className="text-sm font-semibold text-red-400 mb-2">PII Removal</h3>
              ...
              <div>
                <h3 className="text-sm font-semibold text-pink-400 mb-2">Data Handling</h3>
                <ul className="text-sm text-white/70 space-y-1.5 list-disc list-inside">
        ...
        {/* Future Scope */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-white">🚀 Future Scope &amp; Validation Notes</h2>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4 backdrop-blur-sm">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">User Interviews &amp; Surveys</p>
                <p className="text-sm text-white/70">Conduct direct user research to validate review-derived insights and test Discovery Agent prototypes with real listeners.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-white/40 mt-0.5 shrink-0">→</span>
              <div>
                <p className="text-sm font-semibold text-white">Full Catalog Integration</p>
                <p className="text-sm text-white/70">Connect to Gaana&apos;s internal catalog and playback APIs for real track results, audio previews, and one-tap play.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-white/40 mt-0.5 shrink-0">→</span>
              <div>
                <p className="text-sm font-semibold text-white">Collaborative Filtering &amp; Listening History</p>
                <p className="text-sm text-white/70">Layer user profiles and collaborative filtering on top of LLM-based discovery for truly personalized results.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-white/40 mt-0.5 shrink-0">→</span>
              <div>
                <p className="text-sm font-semibold text-white">A/B Testing &amp; Metrics</p>
                <p className="text-sm text-white/70">Measure discovery rate, repeat-play reduction, and session length improvements through controlled experiments.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Known Limitations */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-white">⚠️ Known Limitations</h2>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
        ...
        <div className="text-center">
          <Link
            href="/"
            className="inline-block bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-6 py-3 rounded-xl font-semibold transition-colors shadow-lg shadow-red-500/25 focus:outline-none focus:ring-2 focus:ring-red-500"
          >
            ← Back to Home
          </Link>
        </div>
