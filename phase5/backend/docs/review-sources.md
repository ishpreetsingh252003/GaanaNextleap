...
- Web / News: live mode needs a configured search provider. Supported keys: `BRAVE_SEARCH_API_KEY`, `TAVILY_API_KEY`, `SERPAPI_API_KEY`, or `WEB_SEARCH_PROVIDER` plus `WEB_SEARCH_API_KEY`.
